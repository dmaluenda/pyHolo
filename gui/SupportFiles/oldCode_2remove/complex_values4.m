...
N1=170;N2=170; %Usable values from SLMs
...
B1(1,1:round((N1/st*2)^4/2))=0;   %initializing
...
data=[rho1;phi1;aux1_i;aux1_j;aux1_k;aux1_l];
fid = fopen(['ComplexValues4_' num2str(st) '_SLM' num2str(1) '.txt'],'wt');
...
data=[rho1;phi1;aux1_i;aux1_j;aux1_k;aux1_l];
fid = fopen(['ComplexValues4_' num2str(st) '_SLM' num2str(2) '.txt'],'wt');
fprintf(fid,'%hu  %hu  %hu  %hu  %hu  %hu\n',data);
fclose(fid);
